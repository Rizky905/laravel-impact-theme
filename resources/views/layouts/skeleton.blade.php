...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/vendor/css/dashboard.css') }}" type="text/css">
...
<body>
    ...
    <!-- Argon JS -->
    <script src="{{ asset('/vendor/js/dashboard.js?v=1.2.0') }}"></script>
    <!-- Demo JS - remove this in your project -->
    <script src="{{ asset('/vendor/js/demo.min.js') }}"></script>
